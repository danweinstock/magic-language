	...
	<h1 class="blue-text">Enter your information</h1>
		<ol class="register-form">
			...
			<li>
				...
				<button class="	 blue-button" type="button">A.In Home</button>
				<button class="location-type-button blue-button" type="button">B. Group Location</button>
			...
			<li>
				...
				<button class="blue-button age-button" type="button">Fall 2016 (Sept. - Nov.)</button><br>
				<button class="blue-button age-button" type="button">Winter 2017 (Jan. - Mar.)</button><br>
				<button class="blue-button age-button" type="button">Spring 2017 (Apr. - Jun.)</button><br>
				<button class="blue-button age-button" type="button">Full Year (Sept. 2016 - Jun. 2017)</button><br>
